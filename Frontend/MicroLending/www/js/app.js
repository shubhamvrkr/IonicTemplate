...
myApp.run(function ($ionicPlatform, $ionicPush,getCurrentUserData,$state,$timeout,databaseFactory,$http) {
    ...
    $ionicPlatform.ready(function () {
      ...
      // for form inputs)
       ...
       if (window.cordova) {
		...
		console.log("Notification Handler Start");
		//storeDatainDatabase("hello")
		getCurrentUserData.getData(function(response){
				
			console.log("user Key Store: ",response.data);
			if(response.data!=null){
			
				$timeout(function() { $state.go('menu.allContracts'); },0);   
		...
		function storeDatainDatabase(data){
			...
			/*var data = {
				body : "{\"sig_s\":\"573654da1df7f9e28262d53e1de41e79e473edf84d3ba5833a2f4cccc0ad680a\",\"sig_r\":\"6d3bd311a1f2b450c6939eb97fba5ced666c9a2a64e15937d8300299375478fc\",\"sig_v\":\"27\",\"contract_data\":\"\",\"nonce\":\"1493718238753\",\"from\":\"0x7cfc30715cebc9ce62e613c00dae51a5e5060438\",\"key_symmteric\":{\"alg\":\"curve25519-xsalsa20-poly1305\",\"nonce\":\"5TIK9L1UthD/1VO3fnq6bZWEFZ6AFp9R\",\"ciphertext\":\"GYPGU1igoByaJo+rStnmqUrlAZOB/Wp8iUXEreAVruwuwg+o+FORSE0VWZToIHAS4HMrJje6kxz7aYvM\"},\"dealId\":\"62393966\",\"transactionHash\":\"0x4a661218018ba65dfbb771bd3dd930b436bf76ece5c781ca1886592efcc237a3\"}"
			}*/
			//var invoker = "nitesh1@mailinator.com";
			...
			try{
					...
					if(response.status=="0"){
						...
						$http.get(apiUrl+"/api/users?email="+invoker).then(function(response) {
							...
							databaseFactory.putData(contact_db, contactEntry, function (response) {
									...
									if (response.status == "0") {
									  console.log("Error storing contact in local db");
									} else {
				...
				console.log("Error in processing notification: ",err)
			}
		}
